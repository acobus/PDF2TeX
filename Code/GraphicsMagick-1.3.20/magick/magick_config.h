...
#define GM_BUILD_LIBS "-ljbig -ltiff -ljpeg -lpng12 -lXext -lX11 -llzma -lz -lm -lgomp -lpthread"
...
#define MagickCoderModulesPath "/usr/local/lib/GraphicsMagick-1.3.20/modules-Q8/coders/"

/* Subdirectory of lib where coder modules are installed */
#define MagickCoderModulesSubdir "GraphicsMagick-1.3.20/modules-Q8/coders"

/* Location of filter modules */
#define MagickFilterModulesPath "/usr/local/lib/GraphicsMagick-1.3.20/modules-Q8/filters/"

/* Subdirectory of lib where filter modules are installed */
#define MagickFilterModulesSubdir "GraphicsMagick-1.3.20/modules-Q8/filters"

/* Directory where architecture-dependent configuration files live. */
#define MagickLibConfigPath "/usr/local/lib/GraphicsMagick-1.3.20/config/"

/* Subdirectory of lib where architecture-dependent configuration files live.
   */
#define MagickLibConfigSubDir "GraphicsMagick-1.3.20/config"

/* Directory where architecture-dependent files live. */
#define MagickLibPath "/usr/local/lib/GraphicsMagick-1.3.20/"

/* Subdirectory of lib where GraphicsMagick architecture dependent files are
   installed */
#define MagickLibSubdir "GraphicsMagick-1.3.20"

/* Directory where architecture-independent configuration files live. */
#define MagickShareConfigPath "/usr/local/share/GraphicsMagick-1.3.20/config/"

/* Subdirectory of lib where architecture-independent configuration files
   live. */
#define MagickShareConfigSubDir "GraphicsMagick-1.3.20/config"

/* Directory where architecture-independent files live. */
#define MagickSharePath "/usr/local/share/GraphicsMagick-1.3.20/"
